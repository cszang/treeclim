...
#' 
#' Single months or ranges of months can be excluded from analysis. This is
#' helpful for e.g. excluding winter months without cambial activity.
...
#' @examples
#' exfr(-5:10, -10:3)
#' @seealso \code{link{.range}}, \code{link{.mean}}, \code{link{.sum}}
#' @export

...
##' Dendroclimatic calibration: response and correlation function
##' analysis
##'
...
##' integers) to current years September (9, months of the current
##' year are specified as positive integers) as model parameters.
##'
##' More complex parameter selections can be obtained by the
##' \emph{modifiers} provided in bootres2: \code{.range},
...
##' can be chained together, bootres2 will not check for meaningful
...
##'
##' In case of response function analysis 1000 bootstrap samples are
##' taken from the original distribution and an eigen decomposition of
##' the standardized predictor matrix is performed. Nonrelevant
...
##' @param climate \code{data.frame} with climatic data in monthly
##' resolution, with year, month and climate parameters in
##' columns. All columns except year and month will be recognized as
##' parameters for response or correlation function.

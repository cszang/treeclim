.onAttach <- function(...) {
  ...
  hello <- paste("This is climtree version ", version, ".", sep = "")
  afool <- substr(date(), 5, 10) == "Apr 01"
  afoolt <- ifelse(afool,
                   "You should not wear this shirt for work...\n", "")
  tips <- c(
    "Need help? See the wiki at https://github.com/znag/climtree/wiki",
    ...
    "See citation('climtree') for information how to cite this package in your work." 
  )

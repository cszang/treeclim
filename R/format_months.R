...
#' 
#' Get positions for supplied numeric month ids in the 2-year span under
#' consideration, and connect to abbreviated month names for previous and
#' current year.
#' 
...
format_month <- function(month) {
  # 2 possibilities: continuous or non-continuous. if it is not continuous, it
  # will either be correctly specified by the user, or it will be supplied
  # correctly by exclude_from. it is not possible to mix ranges through zero
  # with other specifications (e.g., c(-4:3, 1, 5) is not possible).

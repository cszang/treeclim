...
##' 14:2486–2492. #' @examples \dontrun{ data(muc.clim) # climatic
##' data data(muc.spruce) # spruce data dc.cor <- dcc(muc.spruce,
##' muc.clim, 3:9, method = "cor", moving = TRUE) gershunov(dc.cor) }
##' @keywords test
##' @export

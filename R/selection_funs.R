...
#' 
#' deconstructs the call to a modifier into a list for further processing with
#' the list-based parameter selection functions
#' @keywords internal
...
#' 
#' These modifiers are used to select specific months from specific climate
#' parameters, and potentially transform the selections into their respective
#' sums or means. The modifiers can be chained together using `+`.
#' @rdname bootres2-modifiers
#' @param .months numeric identifiers for the months (-1 for previous January
#'   until 12 for current December, with -6 for previous June, etc.)
